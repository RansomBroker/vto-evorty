@extends('master')
@section('title', 'Manage Earring Product')
@section('content')
...
<div class="layout-container">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-end mb-3">
                            <a href="{{ route('earring.vto.all', $brand->slug)}}" class="me-2 btn btn-secondary"><i
                                    class='bx bx-show'></i>View VTO</a>
                        ...
                        <div class="card mb-3 shadow-lg">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-start">
                                    <button type="button" class="btn-edit btn btn-success btn-sm m-2 p-2 rounded-circle"
                                        data-id="{{ $product->id }}"><i class='bx bx-edit-alt'></i></button>
                                    <form action="{{ route('earring.delete', $product->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger btn-sm m-2 rounded-circle p-2"><i
                                                class='bx bx-trash'></i></button>
                                    </form>
                                    <a href="{{ route('earring.vto', [$brand->slug, $product->slug]) }}"
                                        class="btn btn-secondary btn-sm m-2 p-2 rounded-circle"><i
                        ...
                        <div class="row">
                            ...
                            <div class="form-group mb-3 col-lg-6 col-12 row">
                                <div class="form-group col-lg-8 col-12">
                                    ...
                                    <input type="file" id="modelFile" class="form-control mb-3" name="modelFile"
                                        required>
                                </div>
                                <div class="form-group dropdown col-lg-4 col-12">
                                    <label for="" class="form-label textwhite">List Materials<span
                    ...
                    <form id="editProduct" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group mb-3 col-lg-6 col-12 row">
                                <div class="form-group col-lg-8 col-12">
                                    <label for="" class="form-label">Model 3d <span class="text-danger">*</span></label>
                                    <input type="file" id="modelFileEdit" class="form-control mb-3" name="modelFileEdit"
                                        required>
                                </div>
                                <div class="form-group dropdown col-lg-4 col-12">
                                    <label for="" class="form-label textwhite">List Materials<span
    ...
    @push('script')
    <script src="{{ asset('assets/evorty/js/earring-product-add.js') }}"></script>
    @endpush
</div>
