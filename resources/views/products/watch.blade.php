...
@section('content')
    ...
    <div class="layout-container">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end mb-3">
                                <a href="{{ route('watch.vto.all', $brand->slug)}}" class="me-2 btn btn-secondary"><i
                                ...
                                <div class="card mb-3 shadow-lg">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-start">
                                            ...
                                            <form action="{{ route('watch.delete', $product->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger btn-sm m-2 rounded-circle p-2"><i
                                                        class='bx bx-trash'></i></button>
                                            </form>
                                            <a href="{{ route('watch.vto', [$brand->slug, $product->slug]) }}"
        ...
        @push('script')
            <script src="{{ asset('assets/evorty/js/watch-product-add.js') }}"></script>
        @endpush
    </div>
