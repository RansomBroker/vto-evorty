...
<body class="bg-dark-alpha">
                            ...
                            <div class="card border-0 rounded-0">
                                <div class="card-body p-0 card-material">
                                    ...
                                    <nav class="px-2 pt-1 nav nav-pills mb-2 carousel-material-list owl-carousel owl-theme border-bottom"
                                        ...
                                        <button
                                            class="btn btn-tab pb-1 p-0 fs-material-list text-uppercase text-body font-weight-bold nav-item tab-selected tab-active"
                                            id="material-0-tab" data-material="0" data-toggle="tab"
                                            href="#material-list-container-0" role="tab">
                                            Lips
                                        </button>
                                        <button
                                            class="btn btn-tab pb-1 p-0 fs-material-list text-uppercase text-body font-weight-bold nav-item tab-selected"
                                            id="material-1-tab" data-material="1" data-toggle="tab"
                                            href="#material-list-container-1" role="tab">
                                            Cheeks
                                        </button>
                                        <button
                                            class="btn btn-tab pb-1 p-0 fs-material-list text-uppercase text-body font-weight-bold nav-item tab-selected"
                                            id="material-2-tab" data-material="2" data-toggle="tab"
                                            href="#material-list-container-2" role="tab">
                                            Eye
                                        </button>
                                    </nav>
                                    ...
                                    <div class="d-flex justify-content-start px-2">
                                        ...
                                        <div class="product-container d-flex justify-content-start">
                                            <!-- image -->
                                            <img class="ml-2 img-thumbnail-product" src="https://placehold.co/80"
                                                alt="">
                                            <!-- Text -->
    ...
    <!-- INCLUDE DEMO SCRIPT -->
    <script src="{{ asset('assets/webarrock/js/face.js') }}"></script>
</body>
